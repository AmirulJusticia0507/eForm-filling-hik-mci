    ...
    <div class="container overflow-hidden">
      <div class="row gy-3 gy-lg-0 align-items-lg-center justify-content-lg-between">
        <div class="col-12 col-lg-6 order-1 order-lg-0">
          <h1 class="display-3 fw-bolder mb-3">e-Form Filling BPRS HIK MCI Yogyakarta.</h1>
          <p class="fs-4 mb-5">Pastikan Anda tidak melewatkan peluang keuangan yang menarik! Isilah E-Form untuk mengajukan pembiayaan di PT BPRS HIK MCI sekarang. Dengan langkah cerdas ini, Anda bisa mewujudkan impian finansial Anda dengan mudah dan cepat. Jadi, segera isi E-Form dan buka pintu menuju masa depan yang lebih cerah.</p>
        </div>
        <div class="col-12 col-lg-5 text-center">
          ...
          <img class="img-fluid" loading="lazy" src="./img/eform-removebg-preview.png" alt="">
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 class="display-3 fw-bolder mb-4">E-FORM <span class="green-text">PT BPRS HIK MCI</span><br></h2>
            <p>Lebih mudah dan praktis dalam Pembukaan Rekening Tabungan, Pengajuan Pembiayaan, dan Penempatan Deposito di PT BPRS HIK MCI</p>
          </div>
        </div>
      </div>
      ...
      <div class="container overflow-hidden">
        <div class="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <h4 class="mb-3">Tabungan</h4>
            <p class="mb-3 text-secondary">Segera buka rekening tabungan di PT BPRS HIK MCI dengan langkah yang mudah dan praktis. Kami menawarkan banyak kejutan menarik untuk Anda.</p>
            <a href="eform_filling_tabungan.php?page=eform_filling_tabungan" class="fw-bold text-decoration-none link-primary">
              Learn More
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <a href="eform_filling_pembiayaan.php?page=eform_filling_pembiayaan" class="fw-bold text-decoration-none link-primary">
              Learn More
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
              </svg>
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <p class="mb-3 text-secondary">Segera buka Deposito di PT BPRS HIK MCI dengan langkah yang mudah dan praktis. Kami menawarkan banyak kejutan menarik untuk Anda.</p>
            <a href="eform_filling_deposito.php?page=eform_filling_deposito" class="fw-bold text-decoration-none link-primary">
              Learn More
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
              </svg>
